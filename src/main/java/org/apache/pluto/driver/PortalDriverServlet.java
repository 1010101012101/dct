...
public class PortalDriverServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// Resource request
			...
			try {
				if (request.getParameterNames().hasMoreElements())
					setPublicRenderParameter(request, portalURL,
							portalURL.getResourceWindow());
		...
		// Otherwise (actionWindowConfig == null), handle the render request.
			...
			if (pageConfig == null) {
				String renderPath = (portalURL == null ? "" : portalURL
						.getRenderPath());
			...
			String uri = (pageConfig.getUri() != null) ? pageConfig.getUri()
					: DEFAULT_PAGE_URI;
			if (LOG.isDebugEnabled()) {
	...
	private void setPublicRenderParameter(HttpServletRequest request,
			PortalURL portalURL, String portletID) throws ServletException,
		...
		PortletDefinition portletDD = container.getOptionalContainerServices()
		...
		if (parameterNames != null) {
			while (parameterNames.hasMoreElements()) {
				...
				if (portletDD.getSupportedPublicRenderParameters() != null) {
					if (portletDD.getSupportedPublicRenderParameters()
							.contains(parameterName)) {
						String value = request.getParameter(parameterName);
						portalURL.addPublicParameterActionResourceParameter(
								parameterName, value);
					}
				}
			}
