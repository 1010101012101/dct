 ...
 * </ol>
 *
 * @version $Revision: 1.4 $ $Date: 2009/05/21 01:43:41 $
 * @since Sep 22, 2004
 */
public class PortalStartupListener implements ServletContextListener {
    ...
    /**
     * The KEY with which the vwb configration is bound to the context.
     */
    private static final String VWB_CONFIG_KEY=AttributeKeys.VWB_CONFIG	;
...
//        destroyVWBConfiguration(servletContext);
...
//    private void destroyVWBConfiguration(ServletContext servletContext){
//    	VWBConfiguration vwbconfig = (VWBConfiguration)servletContext.getAttribute(VWB_CONFIG_KEY);
//    	try{
//    	if (vwbconfig!=null){
//    		vwbconfig.destory();
//    	}
//	    }catch (VWBConfigurationException e){
//	    	  LOG.error("Unable to destroy vwb config: "
//                      + e.getMessage(), e);
//	    }finally{
//	    	servletContext.removeAttribute(VWB_CONFIG_KEY);
//	    	PortalSessionServiceImpl.init(null);
//	    }
//    	
//    }
    /**
