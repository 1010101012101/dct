...
import cn.vlabs.duckling.vwb.InternalVWBException;
...
public final class TextUtil
{
    ...
    public static String urlEncodeUTF8( String text )
    {
        ...
        {
            throw new InternalVWBException("UTF-8 not supported!?!");
        }
    ...
    public static String urlDecodeUTF8( String utf8 )
    {
        ...
        {
            throw new InternalVWBException("UTF-8 or ISO-8859-1 not supported!?!");
        }
    ...
    public static String urlEncode( String data, String encoding )
    {
        ...
        {
            throw new InternalVWBException("Could not encode String into" + encoding);
        }
    }
               ...
               IllegalArgumentException
    {
        ...
        {
            throw new InternalVWBException("Could not decode String into" + encoding);
        }
