 ...
 * @author zzb
 */
public abstract class BaseTemplateProvider extends ContainerBaseDAO implements BackupProvider {
	public static final int PAGESIZE = 10;
	protected static final XStream XSTREAM = new ConfigReader().getStream();
}
