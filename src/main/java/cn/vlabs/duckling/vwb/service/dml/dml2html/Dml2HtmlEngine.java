...
import cn.vlabs.duckling.vwb.service.dml.html2dml.WhitespaceTrimWriter;
...
public class Dml2HtmlEngine {
	...
	private String view_Mode = "0";// 在浏览页面下判断是浏览模式还是编辑模式0是浏览1编辑
	private DmlContext dmlcontext;
	private boolean m_wysiwygEditorMode;// 在编辑状态查看该区域是属于fck内部还是外部
	private int h1index;
	private int h2index;
	private int h3index;
	private int h4index;
	...
	public String getCLBBaseurl() {
		return dmlcontext.getCLBBaseUrl();
	}
	...
	public boolean isM_wysiwygEditorMode() {
		return m_wysiwygEditorMode;
	}

	public void setM_wysiwygEditorMode(boolean editorMode) {
		m_wysiwygEditorMode = editorMode;
	}
