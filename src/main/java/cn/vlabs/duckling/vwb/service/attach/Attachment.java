...
/**
 * Describes an attachment. Attachments are actually derivatives of a WikiPage,
 * since they do actually have a WikiName as well.
 * 
 * @author Yong Ke
 */
public class Attachment extends DPage {
	private String m_fileName;
	private String m_parentName;
	private boolean m_cacheable = true;

	/**
	 * Creates a new attachment. The final name of the attachment will be a
	 * synthesis of the parent page name and the file name.
	 * 
	 * @param parentPage
	 *            The page which will contain this attachment.
	 * @param fileName
	...
	public String toString() {
		return "Attachment [" + this.getTitle() + ";mod=" + this.getTime()
				+ "]";
	}
	 ...
	 * like DynamicAttachments, but it may be useful for certain
	 * AttachmentProviders as well.
	 * 
	 * @param value
