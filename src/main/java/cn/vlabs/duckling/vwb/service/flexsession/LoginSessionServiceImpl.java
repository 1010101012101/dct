...
public class LoginSessionServiceImpl implements LoginSessionService {
	...
	public void setCacheService(VWBCacheService cache){
		this.cache = cache;
		this.cache.setModulePrefix("ls");
	}
	@Override
	public Object getCurrentLoginContext(String sessionId) {
		return cache.getFromCache(GLOBAL_SITE_ID, sessionId);
	}

	@Override
	public void save(String sessionId, Object context) {
		cache.putInCache(GLOBAL_SITE_ID, sessionId, context);
	}
