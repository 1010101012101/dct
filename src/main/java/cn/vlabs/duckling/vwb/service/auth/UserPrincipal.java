...
public final class UserPrincipal implements Principal,Serializable {
	 ...
	 * UNSPECIFIED.
	 */
	public static final Principal GUEST = new UserPrincipal("Guest", "GUEST");
	...
	static {
		VALID_TYPES = new String[] { FULL_NAME, LOGIN_NAME, WIKI_NAME,
				UNSPECIFIED };
	...
	public UserPrincipal(String name, String fullname, String type) {
		...
		// {
		// throw new IllegalArgumentException( "Principal type '" + type +
		// "' is invalid.");
		// }
		m_type = type;
	}
