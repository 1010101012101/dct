...
public class AllPermissionCollection extends PermissionCollection {
	...
	public void add(Permission permission) {
		if (!AllPermission.isSystemPermission(permission)) {
	 ...
	 * {@link PagePermission} or {@link UserPermission}, this method will return
	 * <code>false</code>. If none of the AllPermissions stored in this
	 * collection imply the permission, the method returns <code>false</code>;
	 * conversely, if one of the AllPermission objects implies the permission,
	 * the method returns <code>true</code>.
	 * 
	 * @param permission
	 *            the Permission to test. It may be any Permission type, but
	 *            only the AllPermission, PagePermission or WikiPermission types
