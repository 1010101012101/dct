...
public abstract class BaseServlet extends HttpServlet {
	...
	protected void layout(HttpServletRequest request, HttpServletResponse response, VWBContext context) throws ServletException, IOException{
		getFunctions().layout(request, response, context);
	}
	
	protected void layout(HttpServletRequest request, HttpServletResponse response, VWBContext context, Rendable content) throws ServletException, IOException{
		getFunctions().layout(request, response, context, content);
	}
	...
	protected ActionForward showException(Throwable e, HttpServletRequest request)  {
		return getFunctions().showException(e, request);
	}
	
	protected ActionForward showMessage(String msgkey, HttpServletRequest request, HttpServletResponse response) {
