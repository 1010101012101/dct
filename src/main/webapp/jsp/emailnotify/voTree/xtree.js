...
function WebFXTreeAbstractNode(sText, sPrefix, sAction) {
	this.childNodes  = [];
	this.id     = webFXTreeHandler.getId();
	this.text   = sText || webFXTreeConfig.defaultText;
	this.prefix = sPrefix || webFXTreeConfig.defaultPrefix;
...
function WebFXTree(sText, sPrefix, sAction, sBehavior, sIcon, sOpenIcon, bChecked) {
	this.base = WebFXTreeAbstractNode;
	this.base(sText, sPrefix, sAction);
...
WebFXTree.prototype.getChecked = function () {
...
function WebFXTreeItem(sText, sPrefix, sAction, eParent, sIcon, sOpenIcon) {
	this.base = WebFXTreeAbstractNode;
	this.base(sText, sPrefix, sAction);
	/* Defaults to close */
	if (webFXTreeConfig.usePersistence) {
