...
function domainNotify(content){
	document.getElementById("domainExist").innerHTML = content;
}

function changeSmtpEnable(isEnable){
	...
	var smtppassword2 = document.getElementById("smtppassword2");
	var replyaddress = document.getElementById("replyaddress");
	var sendaddress = document.getElementById("sendaddress");
	if(isEnable==true){
		smtp.disabled = false;
		smtpuser.disabled = false;
		smtppassword.disabled = false; 
		smtppassword2.disabled = false;
		replyaddress.disabled = false;
		sendaddress.disabled = false;
	}
	if(isEnable==false){
		smtp.disabled = true;
		smtpuser.disabled = true;
		smtppassword.disabled = true; 
		smtppassword2.disabled = true;
		replyaddress.disabled = true;
...
<form id="siteform" method="post" action="5027" autocomplete="off">
	<input type="hidden" name="method" value="createSite">
			...
			<td>
				<table width="100%">
					...
					<tr>
						...
						<td class="field" colspan="2">
							<input id="createsubmit" name="createsubmit" type="submit"
