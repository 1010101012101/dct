...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#lSelAll').click(function(){
			$('.siteSelAll').attr("checked", 'true');
			$('.siteSel').attr("checked", 'true');
			
			decideSelOps();
		});
		
		$('#lSelNone').click(function(){
			$('.siteSel').attr("checked", '');
			$('.siteSelAll').attr("checked", '');
	...
	<div>
		<table width="98%">
			<tr>
				...
				<td align="right">
					<a href="<vwb:Link page="5028" format="url"/>"><fmt:message
			...
			<c:forEach var="item" items='${requestScope.allSites}'
				...
				<tr>
					...
					<td>
						<c:choose>
							<c:when test="${item.state.value=='work'}">
								<a href="<vwb:BaseURL siteId='${item.siteId}'/>" target="_blank"> <c:out
...
<div id="startdlg"
	...
	<form id="activateSiteManage"
		action="<vwb:Link page="5024?method=activateSite" format="url"/>"
...
<div id="stopdlg"
	...
	<form id="deactivateSiteManage"
		action="<vwb:Link page="5024?method=deactivateSite" format="url"/>"
		method="post" name="siteManageForm">
...
<div id="destorydlg"
	...
	<form id="destroySiteManage"
		action="<vwb:Link page="5024?method=destroySite" format="url"/>"
		method="post" name="siteManageForm">
...
<div id="templatedlg"
	...
	<form id="createTemplateManage"
		action="<vwb:Link page="5024?method=createTempate" format="url"/>"
		method="post" name="siteManageForm">
...
<div id="dumpdomaindlg"
	...
	<form id="dumpDomainManage"
		action="<vwb:Link page="5024?method=dumpDomain" format="url"/>"
		method="post" name="siteManageForm">
