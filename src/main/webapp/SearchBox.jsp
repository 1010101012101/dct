...
function addSearchBox() {
	...
	var boxleft=(header.offsetWidth+pos.x);
...
url='<vwb:Link context="plain" jsp="" format="url"/>'+'allresource.do';
...
<form method="post" id="searchForm" class="wikiform" accept-charset="UTF-8" action="<vwb:Link page='5018' format='url'/>">
