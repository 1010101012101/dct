...
Ext.onReady(function(){
    ...
    function getURL(){
        return typeof(portalSetting)!= "undefined"?"privilege?cmd=query":'?a=privilege&cmd=query';
    }
    ...
    if ((!allow) || (allow == 'false')) {
		            ...
		            handler: function() {
						...
						Ext.Ajax.request( 
									{   
										...
										url: typeof(portalSetting)!= "undefined"?"privilege?cmd=delete":'?a=privilege&cmd=delete',
										params: { 
												type: typeValue, 
												name: nameValue, 
	            	...
	            	},
	            {
		            ...
		            handler : function(){
						...
						Ext.Ajax.request( 
							{   
								waitMsg: 'Delete privilege...',
								url: typeof(portalSetting)!= "undefined"?"privilege?cmd=publicview":'?a=privilege&cmd=publicview',
								params: {
										pagename: encodeURI(Ext.get('page').getValue()),
										type: p.get('type'),
										name: p.get('name')
		            ...
		            handler : function(){
		             var p = new priv({
			            ...
			            Ext.Ajax.request( 
							{   
								waitMsg: 'Delete privilege...',
								url: typeof(portalSetting)!= "undefined"?"privilege?cmd=public":'?a=privilege&cmd=public',
								params: {
										pagename: encodeURI(Ext.get('page').getValue())
								},							
		...
		grid.on("afteredit", function(obj) {
			...
			Ext.Ajax.request({
				...
				url: typeof(portalSetting)!= "undefined"?"privilege?cmd=save":'?a=privilege&cmd=save',
	     ...
	     // Tree for the center
			var voTree = new Ext.tree.TreePanel({
		        ...
		        loader           : new Ext.tree.TreeLoader({
	        		dataUrl		 : site.getJSPURL('VOTree.do?cmd=query'),
