...
FCKTools.DisableSelection = function(element) {
	...
	var useStyle = (typeof element.style.msUserSelect != "undefined" && !FCKBrowserInfo.IsIE11);
	if (useStyle) {
...
FCKTools.RemoveEventListener = function(sourceObject, eventName, listener, userCapture) {
	...
	if (sourceObject.detachEvent) {
		...
		//IE11
		sourceObject.removeEventListener(eventName, listener, userCapture);
	}
};
