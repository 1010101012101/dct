...
<c:choose>
	<c:when test="${isMax}">
		<div class=DragContainer id=DragContainer6
	...
	<c:otherwise>
		<div class="DragContainer" id="c_left" overclass="OverDragContainer">
			<c:forEach var="portlet" varStatus="status"
		...
		<!-- Right column -->
		<div class="DragContainer" id="c_right" overclass="OverDragContainer">
			<c:forEach var="portlet" varStatus="status"
