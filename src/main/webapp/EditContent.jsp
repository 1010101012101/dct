...
<script type="text/javascript" src="<%=basePath%>scripts/ajax/editor.js"></script>
...
<textarea cols="80" rows="4" name="inTempPage" id="inTempPage"
...
<div id="pagecontent">
	<form id="editform" name="editform" method="post"
		...
		<input type="hidden" name="lockVersion" id="lockVersion"
			value='${lockVersion}'>
		<div id="tab21" class="DCT_tabmenu">
			<div style="float: left" id="submitbuttons">
				<input name='saveexit' type='button' id='okbutton'
					...
					onclick='javascript:submitDEForm(this);' /> <input name='save'
					type='button' id="savebutton"
					value='<fmt:message key="editor.plain.saveedit.submit"/>'
					onclick="javascript:saveDEeditor();" /> <input name='preview'
					type='button' id="previewbutton"
					...
					onclick='javascript:submitDEForm(this);' /> <input name="action"
		...
		<div style="float: left">
			...
			:<input name="title" type="text" id="title"
				value="${editDpage.title}" style="width: 420px" />
		</div>
