...
import cn.vlabs.duckling.vwb.VWBStartupListener;
...
public class SpringManage {
	...
	private void initApplicationContext() {
		String contextxml ="src/main/webapp/WEB-INF/conf/VWBContext.xml";
		try{
	...
	private void initWebRoot(){
		String webRootKey="dct.root";
		String webroot="WebRoot";
		log.info("set web root path["+webRootKey+"]:"+webroot);
		System.setProperty(webRootKey,webroot);
	}
	private void initLog4j(){
		String log4jConfig = "src/main/webapp/WEB-INF/conf/log4j.properties";
